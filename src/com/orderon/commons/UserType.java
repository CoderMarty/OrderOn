...
public enum UserType {
	...
	WAITER(0, 7), MANAGER(1, 4), ADMINISTRATOR(2, 1), CHEF(3, 5), RECEPTIONIST(4, 5), CASHIER(10, 5), STEWARD(11, 7), CAPTAIN(9, 6), DELIVERY(7, 7), OWNER(8, 2), DATAMANAGER(12, 5), SECRET(99, 3), UNAUTHORIZED(100, 8);
